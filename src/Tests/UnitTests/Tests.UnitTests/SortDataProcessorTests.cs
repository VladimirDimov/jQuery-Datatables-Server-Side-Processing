namespace Tests.UnitTests
{
    ...
    internal class SortDataProcessorTests
    {
        ...
        [TestCase(nameof(AllTypesModel.Float), false)]
        [TestCase(nameof(AllTypesModel.FloatNullable), false)]
        ...
        [TestCase("NestedModel.Float", false)]
        [TestCase("NestedModel.FloatNullable", false)]
